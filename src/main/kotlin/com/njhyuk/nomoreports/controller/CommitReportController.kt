...
class CommitReportController(
    ...
    suspend fun generateCommitReport(@RequestBody request: CommitReportRequest): ResponseEntity<Map<String, String>> {
        try {
            ...
            return ResponseEntity.ok<Map<String, String>>(mapOf("report" to markdownReport))
        } catch (e: Exception) {
